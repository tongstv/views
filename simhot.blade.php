...
@section("content")
    ...
    <div class="table-head">
        <h3 class="title text-center">{{$data->simhot->simhot_name}}</h3>
    </div>
    <div class="table">
        <div class="table-body">
            ...
            @foreach($data AS $row)
                <div class="table-row">
                    ...
                    <div class="table-cell table-cell--right sim-price"><del>{{number_format($row->giaban*1000000,0,".",".")}}₫</del></div>
                    <div class="table-cell">7.290.000₫</div>
